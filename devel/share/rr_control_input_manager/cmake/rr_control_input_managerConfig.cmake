...
if("TRUE" STREQUAL "TRUE")
  set(rr_control_input_manager_SOURCE_PREFIX /home/ubuntu/Catkin_ws/src/rr_control_input_manager)
  set(rr_control_input_manager_DEVEL_PREFIX /home/ubuntu/Catkin_ws/devel)
  ...
  set(rr_control_input_manager_INSTALL_PREFIX /home/ubuntu/Catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rr_control_input_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Catkin_ws/src/rr_control_input_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rr_control_input_manager_NUM_DUMMY_TARGETS)
      set(rr_control_input_manager_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rr_control_input_manager::wrapped-linker-option${rr_control_input_manager_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rr_control_input_manager_NUM_DUMMY_TARGETS "${rr_control_input_manager_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rr_control_input_manager::wrapped-linker-option${rr_control_input_manager_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rr_control_input_manager_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rr_control_input_manager_EXPORTED_TARGETS ${${rr_control_input_manager_dep}_EXPORTED_TARGETS})
endforeach()
